...
urlpatterns = [
    ...
    path('accepted-bids/',accepted_bids,name="accepted_bids"),  
    path('assigend-jobs/',assigned_tasks,name='assigned_task') ,
    path('status-update/<int:job_id>/',update_job_status,name='update_status'), 
    path('freelancer-feedback/',recieve_feedback,name='freelancer-feedback'),
    path('upload-work/', upload_work_list, name='upload_completed_work'),
    path('upload-work-action/<int:job_id>/', upload_work_action, name='upload_work_action'),
